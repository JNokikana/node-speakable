...
Speakable.prototype.init = function () {
  ...
  parser.addArgument(['models'], { help: 'Path to the model (protocol buffer binary file)' });
  ...
  console.error('Loading model from file %s', args['models']);
  const model_load_start = process.hrtime();
  setModel(new Ds.Model(args['models'], N_FEATURES, N_CONTEXT, args['alphabet'], BEAM_WIDTH));
  ...
  if (args['lm'] && args['trie']) {
    ...
    getModel().enableDecoderWithLM(args['alphabet'], args['lm'], args['trie'],
